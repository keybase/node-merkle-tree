...
(function() {
  var Base, Config, JSS, Lock, SortedMap, chain_err, format_hex, hex_cmp, hex_len, iced, iutils, json_stringify_sorted, log_16, make_esc, map, node_types, __iced_k, __iced_k_noop, _ref;
  ...
  exports.Base = Base = (function() {
    ...
    Base.prototype.upsert = function(_arg, cb) {
      var curr, esc, h, key, last, level, nxt, obj, obj_s, p, path, ret, root, sm, sorted_map, tmp, v2, val, ___iced_passed_deferral, __iced_deferrals, __iced_k;
    ...
    Base.prototype.find = function(_arg, cb) {
      var curr, esc, key, level, node, p, skip_verify, val, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
