...
(function() {
  ...
  exports.SortedMap = SortedMap = (function() {
    ...
    SortedMap.prototype.to_hash = function(_arg) {
      var JS, hasher, k, key, obj, obj_s, parts, pr, prev_root, tab, tab_s, type, v, _i, _len, _ref1, _ref2;
      hasher = _arg.hasher, type = _arg.type, prev_root = _arg.prev_root;
      JS = JSON.stringify;
  ...
  exports.Base = Base = (function() {
    ...
    Base.prototype.upsert = function(_arg, cb) {
      var arg, curr, esc, h, i, key, last, level, nxt, obj, obj_s, p, path, prev_root, ret, root, sm, sorted_map, tmp, txinfo, v2, val, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      ...
      (function(_this) {
        return (function(__iced_k) {
          __iced_deferrals = new iced.Deferrals(__iced_k, {
            ...
            filename: "/home/max/src/keybase/node-merkle-tree/src/tree.iced",
              ...
              (function(__iced_k) {
                ...
                (function(__iced_k) {
                  if (sorted_map != null) {
                    ...
                    if (path.length === 1 && path[0][1].type === node_types.LEAF) {
                      arg.prev_root = prev_root;
                    }
                    (function(__iced_k) {
                      __iced_deferrals = new iced.Deferrals(__iced_k, {
                        parent: ___iced_passed_deferral,
                      ...
                      _this.hash_tree_r(arg, esc(__iced_deferrals.defer({
                        assign_fn: (function() {
                          return function() {
                      ...
                      (function(__iced_k) {
                        ...
                        _while = function(__iced_k) {
                          ...
                          if (!(i < _len)) {
                            ...
                            _ref3 = _ref2[i], p = _ref3[0], curr = _ref3[1];
                            if (curr.type === node_types.INODE) {
                              ...
                              _ref4 = sm.to_hash(arg), key = _ref4.key, obj = _ref4.obj, obj_s = _ref4.obj_s;
                              h = key;
                              (function(__iced_k) {
                                __iced_deferrals = new iced.Deferrals(__iced_k, {
                                  parent: ___iced_passed_deferral,
    ...
    Base.prototype.hash_tree_r = function(_arg, cb) {
      var C, M, arg, end, err, h, i, j, key, level, new_sorted_map, obj, obj_s, prefix, prev_root, sorted_map, start, sublist, ___iced_passed_deferral, __iced_deferrals, __iced_k, _begin, _end, _positive;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      ...
      (function(_this) {
        return (function(__iced_k) {
          ...
          if (sorted_map.len() <= _this.config.N) {
            ...
            _ref1 = sorted_map.to_hash(arg), key = _ref1.key, obj = _ref1.obj, obj_s = _ref1.obj_s;
            (function(__iced_k) {
              __iced_deferrals = new iced.Deferrals(__iced_k, {
                parent: ___iced_passed_deferral,
                filename: "/home/max/src/keybase/node-merkle-tree/src/tree.iced",
...
_break()
              ...
              (function(__iced_k) {
                ...
                if (err == null) {
                  ...
                  _ref2 = new_sorted_map.to_hash(arg), key = _ref2.key, obj = _ref2.obj, obj_s = _ref2.obj_s;
                  (function(__iced_k) {
                    __iced_deferrals = new iced.Deferrals(__iced_k, {
                      parent: ___iced_passed_deferral,
                      filename: "/home/max/src/keybase/node-merkle-tree/src/tree.iced",
