...
(function() {
  ...
  exports.Base = Base = (function() {
    ...
    Base.prototype.hash_tree_r = function(_arg, cb) {
      var C, M, end, err, h, i, j, key, level, new_sorted_map, obj, obj_s, prefix, prev_root, sorted_map, start, sublist, to_hash_arg, ___iced_passed_deferral, __iced_deferrals, __iced_k, _begin, _end, _positive;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      level = _arg.level, sorted_map = _arg.sorted_map, prev_root = _arg.prev_root;
      err = null;
      key = null;
      to_hash_arg = (function(_this) {
      ...
      (function(_this) {
        return (function(__iced_k) {
          ...
          if (sorted_map.len() <= _this.config.N) {
            _ref1 = sorted_map.to_hash(to_hash_arg(node_types.LEAF)), key = _ref1.key, obj = _ref1.obj, obj_s = _ref1.obj_s;
            (function(__iced_k) {
              __iced_deferrals = new iced.Deferrals(__iced_k, {
                parent: ___iced_passed_deferral,
                filename: "/home/max/src/keybase/node-merkle-tree/src/tree.iced",
...
_break()
              ...
              (function(__iced_k) {
                var _ref2;
                if (err == null) {
                  _ref2 = new_sorted_map.to_hash(to_hash_arg(node_types.INODE)), key = _ref2.key, obj = _ref2.obj, obj_s = _ref2.obj_s;
                  (function(__iced_k) {
                    __iced_deferrals = new iced.Deferrals(__iced_k, {
                      parent: ___iced_passed_deferral,
                      filename: "/home/max/src/keybase/node-merkle-tree/src/tree.iced",
